...
def main():
    ...
    while True:
        print("Use these short codes : bc - create username and password cc - The personal details of the user, dc - display users,zc - Here is a list of all your login credentials,  ex -exit the user list ")
        ...
        if short_code == 'bc':
            ...
            for user in display_credentials():
                ...
                print(f"{credential.username} {credential.username} .....")

                print('\n')
            else:
                print('\n')
                print("You dont seem to have any login credentials saved yet")
                print('\n')
        # elif short_code == 'fc':
